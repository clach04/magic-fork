...
magic = [
    ...
    [0, 'string', '=', b'Core\x01', 'application/x-executable-file'],
    ...
    [0, 'string', '=', b'\nGL', 'application/data'],
    [0, 'string', '=', b'v\xff', 'application/data'],
    [0, 'string', '=', b'NuFile', 'application/data'],
    [0, 'string', '=', b'N\xf5F\xe9l\xe5', 'application/data'],
    [0, 'belong', '=', 333312, 'application/data'],
    [0, 'belong', '=', 333319, 'application/data'],
    [257, 'string', '=', b'ustar\x00', 'application/x-tar'],
    [257, 'string', '=', b'ustar  \x00', 'application/x-gtar'],
    ...
    [0, 'string', '=', b'\x1aarchive', 'application/data'],
    [0, 'leshort', '=', 60000, 'application/x-arj'],
    [0, 'string', '=', b'HPAK', 'application/data'],
    [0, 'string', '=', b'\xe9,\x01JAM application/data', ''],
    ...
    [0, 'string', '=', b'UC2\x1a', 'application/data'],
    [0, 'string', '=', b'PK\x03\x04', 'application/zip'],
    ...
    [0, 'string', '=', b'\x00\x04\x1e\x8a\x80', 'application/core'],
    ...
    [0, 'string', '=', b'GF1PATCH110\x00ID#000002\x00', 'audio/x-gus-patch'],
    [0, 'string', '=', b'GF1PATCH100\x00ID#000002\x00', 'audio/x-gus-patch'],
    ...
    [0, 'string', '=', b'#!/', 'text/script'],
    [0, 'string', '=', b'#! text/script', ''],
    [0, 'string', '=', b'\x1f\x9d', 'application/compress'],
    [0, 'string', '=', b'\x1f\x8b', 'application/x-gzip'],
    [0, 'string', '=', b'\x1f\x1e', 'application/data'],
    [0, 'short', '=', 17437, 'application/data'],
    [0, 'short', '=', 8191, 'application/data'],
    [0, 'string', '=', b'\xff\x1f', 'application/data'],
    ...
    [0, 'string', '=', b'\x1f\x9f', 'application/data'],
    [0, 'string', '=', b'\x1f\x9e', 'application/data'],
    [0, 'string', '=', b'\x1f\xa0', 'application/data'],
    [0, 'string', '=', b'BZ', 'application/x-bzip'],
    [0, 'string', '=', b'\x89LZO\x00\r\n\x1a\n', 'application/data'],
    ...
    [0, 'string', '=', b'\xff\xff\x7f', 'application/data'],
    [0, 'string', '=', b'\xff\xff|', 'application/data'],
    [0, 'string', '=', b'\xff\xff~', 'application/data'],
    [0, 'string', '=', b'\x1bc\x1b', 'application/data'],
    ...
    [4098, 'string', '=', b'DOSFONT', 'font/x-dos'],
    ...
    'string',
    '=',
    b'\xef\x10\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
    ...
    [0, 'string', '=', b'\xde\x12\x04\x95', 'application/x-locale'],
    [0, 'string', '=', b'\x95\x04\x12\xde', 'application/x-locale'],
    [0, 'beshort', '=', 627, 'application/x-executable-file'],
    [0, 'beshort', '=', 624, 'application/x-executable-file'],
    [0, 'string', '=', b'\x00\x01\x00\x00\x00', 'font/ttf'],
    ...
    [0, 'string', '=', b'MM\x00*', 'image/tiff'],
    [0, 'string', '=', b'II*\x00', 'image/tiff'],
    [0, 'string', '=', b'\x89PNG', 'image/x-png'],
    [1, 'string', '=', b'PNG', 'image/x-png'],
    [0, 'string', '=', b'GIF8', 'image/gif'],
    [0, 'string', '=', b'\xf1\x00@\xbb', 'image/x-cmu-raster'],
    ...
    [0, 'string', '=', b'%bitmap\x00', 'FBM image data'],
    [1, 'string', '=', b'PC Research, Inc', 'group 3 fax data'],
    ...
    [0, 'string', '=', b'/* XPM */', 'X pixmap image text'],
    ...
    [2048, 'string', '=', b'PCD_IPI', 'x/x-photo-cd-pack-file'],
    ...
    [0, 'string', '=', b'\x88OPS', 'Interleaf saved data'],
    [0, 'string', '=', b'<!OPS', 'Interleaf document text'],
    [4, 'string', '=', b'pgscriptver', 'IslandWrite document'],
    [13, 'string', '=', b'DrawFile', 'IslandDraw document'],
    ...
    [53, 'string', '=', b'yyprevious', 'C program text (from lex)'],
    [21, 'string', '=', b'generated by flex', 'C program text (from flex)'],
    ...
    [0, 'string', '=', b'\x07\x01\x00', 'Linux/i386 object file'],
    [0, 'string', '=', b'\x01\x03\x10\x04', 'Linux-8086 impure executable'],
    [0, 'string', '=', b'\x01\x03 \x04', 'Linux-8086 executable'],
    [0, 'string', '=', b'\xa3\x86\x01\x00', 'Linux-8086 object file'],
    [0, 'string', '=', b'\x01\x03\x10\x10', 'Minix-386 impure executable'],
    [0, 'string', '=', b'\x01\x03 \x10', 'Minix-386 executable'],
    [0, 'string', '=', b'*nazgul*', 'Linux compiled message catalog'],
    [216, 'lelong', '=', 421, 'Linux/i386 core file'],
    [2, 'string', '=', b'LILO', 'Linux/i386 LILO boot/chain loader'],
    [0, 'string', '=', b'0.9', ''],
    [0, 'leshort', '=', 1078, 'font/linux-psf'],
    [4086, 'string', '=', b'SWAP-SPACE', 'Linux/i386 swap file'],
    [0, 'leshort', '=', 387, 'ECOFF alpha'],
    [514, 'string', '=', b'HdrS', 'Linux kernel'],
    ...
    [11, 'string', '=', b'must be converted with BinHex', 'BinHex binary text'],
    [0, 'string', '=', b'SIT!', 'StuffIt Archive (data)'],
    [65, 'string', '=', b'SIT!', 'StuffIt Archive (rsrc + data)'],
    [0, 'string', '=', b'SITD', 'StuffIt Deluxe (data)'],
    [65, 'string', '=', b'SITD', 'StuffIt Deluxe (rsrc + data)'],
    [0, 'string', '=', b'Seg', 'StuffIt Deluxe Segment (data)'],
    [65, 'string', '=', b'Seg', 'StuffIt Deluxe Segment (rsrc + data)'],
    [0, 'string', '=', b'APPL', 'Macintosh Application (data)'],
    [65, 'string', '=', b'APPL', 'Macintosh Application (rsrc + data)'],
    [0, 'string', '=', b'zsys', 'Macintosh System File (data)'],
    [65, 'string', '=', b'zsys', 'Macintosh System File(rsrc + data)'],
    [0, 'string', '=', b'FNDR', 'Macintosh Finder (data)'],
    [65, 'string', '=', b'FNDR', 'Macintosh Finder(rsrc + data)'],
    [0, 'string', '=', b'libr', 'Macintosh Library (data)'],
    [65, 'string', '=', b'libr', 'Macintosh Library(rsrc + data)'],
    [0, 'string', '=', b'shlb', 'Macintosh Shared Library (data)'],
    [65, 'string', '=', b'shlb', 'Macintosh Shared Library(rsrc + data)'],
    [0, 'string', '=', b'cdev', 'Macintosh Control Panel (data)'],
    [65, 'string', '=', b'cdev', 'Macintosh Control Panel(rsrc + data)'],
    [0, 'string', '=', b'INIT', 'Macintosh Extension (data)'],
    [65, 'string', '=', b'INIT', 'Macintosh Extension(rsrc + data)'],
    [0, 'string', '=', b'FFIL', 'font/ttf'],
    [65, 'string', '=', b'FFIL', 'font/ttf'],
    [0, 'string', '=', b'LWFN', 'font/type1'],
    [65, 'string', '=', b'LWFN', 'font/type1'],
    [0, 'string', '=', b'PACT', 'Macintosh Compact Pro Archive (data)'],
    [65, 'string', '=', b'PACT', 'Macintosh Compact Pro Archive(rsrc + data)'],
    [0, 'string', '=', b'ttro', 'Macintosh TeachText File (data)'],
    [65, 'string', '=', b'ttro', 'Macintosh TeachText File(rsrc + data)'],
    [0, 'string', '=', b'TEXT', 'Macintosh TeachText File (data)'],
    [65, 'string', '=', b'TEXT', 'Macintosh TeachText File(rsrc + data)'],
    [0, 'string', '=', b'PDF', 'Macintosh PDF File (data)'],
    [65, 'string', '=', b'PDF', 'Macintosh PDF File(rsrc + data)'],
    ...
    [0, 'string', '=', b'\xc9\xc4', 'ID tags data'],
    [0, 'string', '=', b'\x01\x01\x01\x01', 'MMDF mailbox'],
    [4, 'string', '=', b'Research,', 'Digifax-G3-File'],
    ...
    [128, 'string', '=', b'PE\x00\x00', 'MS Windows PE'],
    ...
    [2112, 'string', '=', b'MSWordDoc', 'text/vnd.ms-word'],
    ...
    [2114, 'string', '=', b'Biff5', 'application/vnd.ms-excel'],
    [0, 'belong', '=', 6656, 'Lotus 1-2-3'],
    [0, 'belong', '=', 512, 'Lotus 1-2-3'],
    [1, 'string', '=', b'WPC', 'text/vnd.wordperfect'],
    ...
    [0, 'string', '=', b'\x04%!', 'application/postscript'],
    [0, 'belong', '=', 3318797254, 'DOS EPS Binary File'],
    [0, 'string', '=', b'*PPD-Adobe:', 'PPD file'],
    [0, 'string', '=', b'\x1b%-12345X@PJL', 'HP Printer Job Language data'],
    [0, 'string', '=', b'\x1b%-12345X@PJL', 'HP Printer Job Language data'],
    [0, 'string', '=', b'\x1bE\x1b', 'image/x-pcl-hp'],
    ...
    [38, 'string', '=', b'Spreadsheet', 'sc spreadsheet file'],
    [8, 'string', '=', b'\x01s SCCS', 'archive data'],
    ...
    [0, 'string', '=', b'TRSNIFF data    \x1a', 'Sniffer capture file'],
    [0, 'string', '=', b'XCP\x00', 'NetXRay capture file'],
    ...
    [36, 'string', '=', b'acsp', 'Kodak Color Management System, ICC Profile'],
    [0, 'string', '=', b'#!teapot\nxdr', 'teapot work sheet (XDR format)'],
    [0, 'string', '=', b'\x1a\x01', 'Compiled terminfo entry'],
    [0, 'short', '=', 433, 'Curses screen image'],
    [0, 'short', '=', 434, 'Curses screen image'],
    [0, 'string', '=', b'\xf7\x02', 'TeX DVI file'],
    [0, 'string', '=', b'\xf7\x83', 'font/x-tex'],
    [0, 'string', '=', b'\xf7Y', 'font/x-tex'],
    [0, 'string', '=', b'\xf7\xca', 'font/x-tex'],
    [0, 'string', '=', b'This is TeX,', 'TeX transcript text'],
    [0, 'string', '=', b'This is METAFONT,', 'METAFONT transcript text'],
    [2, 'string', '=', b'\x00\x11', 'font/x-tex-tfm'],
    [2, 'string', '=', b'\x00\x12', 'font/x-tex-tfm'],
    ...
    b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00',
    'old timezone data'],
    [0,
    'string',
    '=',
    b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
    b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x00',
    'old timezone data'],
    [0,
    'string',
    '=',
    b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
    b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x03\x00',
    'old timezone data'],
    [0,
    'string',
    '=',
    b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
    b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x04\x00',
    'old timezone data'],
    [0,
    'string',
    '=',
    b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
    b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x05\x00',
    'old timezone data'],
    [0,
    'string',
    '=',
    b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
    b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x06\x00',
    'old timezone data'],
    ...
    [0, 'string', '=', b'@\xef', 'very old (C/A/T) troff output data'],
    ...
    [596, 'string', '=', b'X\xdf\xff\xff', 'Ultrix core file'],
    ...
    [43, 'string', '=', b'SFDU_LABEL', 'VICAR label file'],
    [0, 'short', '=', 21845, 'VISX image file'],
    [0, 'string', '=', b'\xb0\x000\x00', 'VMS VAX executable'],
    [0, 'belong', '=', 50331648, 'VMS Alpha executable'],
    [1, 'string', '=', b'WPC', '(Corel/WP)'],
